...
Denna rapport sammanställer och analyserar inkomstdata från Statistiska centralbyrån (SCB). Syftet är att undersöka hur medelinkomsten varierar beroende på faktorer som utbildningsnivå, kön och ålder samt hur dessa realtioner har förändrats över tid. Datan sträcker sig från `{python} first_year` och `{python} latest_year`.
